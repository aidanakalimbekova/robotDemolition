...
int main() {
    ...
    do {
        ...
        for ( int r = 0; r < 10; r++ ) {
            for ( int d = 0; d < 10; d++ ) {
                if ( grid[r][d].hasRobot == 0 ) {
                    printf(".");
                } else if ( grid[r][d].hasRobot == 1 && grid[r][d].robAlive == 1 ) {
                    printf("R");
                } else if ( grid[r][d].robAlive == 0 ) {
                    ...
                    case 0: // Pointing west
                        if ( column > 0 ) {
                            ...
                            if ( grid[row][column - 1].hasRobot == 1 ) {
                                if ( grid[row][column - 1].robAlive == 0 ) {
                                    liveCount--;
                    ...
                    case 1: // Pointing north
                        if ( row > 0 ) {
                            ...
                            if ( grid[row - 1][column].hasRobot == 1 ) {
                                if ( grid[row - 1][column].robAlive == 0 ) {
                                    liveCount--;
                                    grid[row][column].robAlive = 0;
                                } else {
